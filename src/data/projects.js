...
const myProjects = [
    ...
    },
    {
        ...
        overview: "An Blog Application. User can create a new blog, edit and delete. Reader can line, dislike, comment,reply, search and filter",
    ...
    },
    {
        ...
        overview: "An to application. Imran can create todo, complate todo and delete todo",
    ...
    },
    {
        ...
        tech: ['html', 'css', 'js', 'react', 'firebase'],
        live: 'https://agitated-shockley-4afe03.netlify.app/',
        repo: 'https://github.com/imranBappy/quiz_app_firebase.git',
        img: quiz
    },
    {
        id: 9,
    ...
    },
    {
        ...
        overview: "An admin dashboard. Admin can see all details such as earning status, total income, Passive Income and other information",
    ...
    },
    {
        ...
        overview: "An crypto animation landing page. there are many section such as, hero section,  Arbitrage section, Who we are section and other section",
        tech: ['html', 'css', 'js'],
    ...
    },
    {
        ...
        overview: "An portfolio website. Use can change theme light and dark. There are many section  hero, Services section, Portofolio section and others",
    ...
    },
    {
        ...
        overview: "An todo application. Imran can create todo, complate todo and delete todo",
    ...
    },
    {
        ...
        overview: "An color generator. User can genetator dynamic color and set background",
        tech: ['html', 'css', 'js'],
    ...
    },
    {
        ...
        overview: "An number converter system. User can any number system to any number system in real time and text to binary and binary to text",
        tech: ['html', 'css', 'js'],
        live: 'https://number-system.netlify.app',
